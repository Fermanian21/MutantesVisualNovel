...
func _ready() -> void:
	...
	event_node = preload("res://addons/dialogic/Editor/Events/EventBlock/event_block.tscn")
	if event_node == null:
		print("ERRO CRÍTICO: O arquivo event_block.tscn não foi encontrado no caminho especificado!")
...
func load_event_buttons() -> void:
	...
	# Event buttons
	var button_scene := load("res://addons/dialogic/Editor/TimelineEditor/VisualEditor/add_event_button.tscn")	
